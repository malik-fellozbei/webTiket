        ...
        <div class="flex items-center">
            ...
            <div class="hidden md:flex md:items-center md:space-x-8 md:pr-8">
                <ul class="flex space-x-8 font-medium">
                    <li>
                        <a href="{{ route('home') }}" class="text-black hover:text-blue-400 transition-colors" aria-current="page">Home</a>
                    </li>
                    <li>
                        <a href="{{ route('blog') }}" class="text-black hover:text-blue-400 transition-colors">Blog</a>
                    </li>
                    <li>
                        <a href="{{ route('event') }}" class="text-black hover:text-blue-400 transition-colors">Event</a>
                    </li>
                    <li>
                        <a href="{{ route('myticket') }}" class="text-black hover:text-blue-400 transition-colors">My Ticket</a>
                    </li>
                </ul>
            </div>
            ...
            @guest
            <!-- Login Button -->
            <a href="{{ route('login') }}" class="text-black border font-medium hover:bg-white/20 rounded-full text-sm px-7 py-2 text-center hidden md:block">Login</a>
            @endguest
        ...
        <div class="px-8 pt-4 pb-6">
            <div class="bg-black/30 backdrop-blur-sm rounded-lg border border-white/60 shadow-lg">
                <ul class="flex flex-col p-4 space-y-2 font-medium">
                    <li>
                        <a href="{{ route('home') }}" class="block py-3 px-4 text-white rounded-lg hover:bg-white/10 transition-colors" aria-current="page">Home</a>
                    </li>
                    <li>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function handleScroll() {
            if (window.scrollY > 50) {
                ...
                navbar.classList.remove('bg-white/60', 'backdrop-blur-sm', 'shadow-lg');
            }
        }
