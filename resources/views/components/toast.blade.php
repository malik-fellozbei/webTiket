...
<div id="toast-notification" class="fixed top-5 right-5 z-50 flex items-center w-full max-w-xs p-4 mb-4 text-black bg-white rounded-lg shadow-lg dark:text-gray-400
