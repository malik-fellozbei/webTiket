...
<main>
    <x-navbar />
    <div class="min-h-screen pt-28 bg-cover bg-center flex items-center justify-center p-4" style="background-image: url({{ Storage::url('images/authBackground.jpg') }});">
        ...
        <div class="relative z-10 flex flex-col lg:flex-row w-full max-w-6xl rounded-lg overflow-hidden shadow-2xl">
            ...
            <div class="w-full lg:w-1/2 bg-white p-8 md:p-12 flex flex-col justify-center items-center">
                <div class="w-full max-w-md">
                    <h2 class="text-xl md:text-2xl font-semibold text-gray-800 mb-6 text-center">WELCOME BACK</h2>
                    <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center">Log In to your Account</h3>
                    ...
                    <form action="{{ route('loginAccount') }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <input id="remember_me" name="remember_me" type="checkbox" class="h-4 w-4 text-gray-900 focus:ring-gray-700 border-gray-300 rounded">
                        ...
                        <div>
                            <button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-md font-medium text-white bg-gray-900 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-700">
                                CONTINUE
                            </button>
                        </div>
                    </form>
                    ...
                    <div class="mt-8 text-center text-sm text-gray-600">
                        New User? <a href="{{ route('register') }}" class="font-medium text-blue-600 hover:text-blue-500">SIGN UP HERE</a>
                    </div>
                </div>
            </div>
        </div>
